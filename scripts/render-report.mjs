 ...
 *
 *   node render-report.mjs <report.json> [out.md]   # CLI
 *   import { renderMarkdown } from './render-report.mjs'   # or importable
 *
...
/** The marker the review bot searches for when updating a previous comment. */
export const REVIEW_MARKER = '<!-- kintsugi-review -->';

/** Turn a parsed report (as produced by `--json`) into a PR comment. */
export function renderMarkdown(report) {
  ...
  const counts = { proposed: 0, escalated: 0, attempted: 0, none: 0 };
...
/** True when this module was executed directly (CLI), not imported. */
function isMain() {
